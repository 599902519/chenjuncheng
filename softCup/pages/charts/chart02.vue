...
<script>
	...
	export default {
		...
		onLoad:function () {
						uni.request({
								url: this.url+"devInfo/consume?year=2018",  //仅为示例，并非真实接口地址。
								data: {
								...
								success: (res) => {
									...
									for(var obj of arr){
										...
										this.data2.push({value:obj.装船机+obj.斗轮机+obj.皮带机, name:obj.港口名称});
									}
		...
		methods: {
			...
			lineInit(canvas, width, height) {
				console.log(this.data1);console.log(this.data2);
